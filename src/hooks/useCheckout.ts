...
export function useCheckout(): UseCheckoutReturn {
        ...
        (field: string) => {
            ...
            switch (field) {
                ...
                case 'email':
                    ...
                    else if (!isValidEmail(formData.customerEmail)) errorMsg = 'Enter a valid email address';
                    break;
                case 'line1':
                ...
                case 'postalCode':
                    ...
                    else if (!isValidPostalCode(addr.postalCode)) errorMsg = 'Enter a valid US zip code (e.g., 12345)';
                    break;
            }
    ...
    const validateShippingForm = useCallback((): boolean => {
        ...
        if (!formData.customerEmail.trim()) newErrors.email = 'Email is required';
        else if (!isValidEmail(formData.customerEmail)) newErrors.email = 'Enter a valid email address';
        ...
        else if (!isValidPostalCode(addr.postalCode)) newErrors.postalCode = 'Enter a valid US zip code';
